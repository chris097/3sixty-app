...
const DotSquare = (props) => {
  return (
    <div className={`relative ${props.top} ${props.left}`}>
      <svg className={`absolute ${props.mg}`} width="155" height="145" viewBox="0 0 155 145" fill="none" xmlns="http://www.w3.org/2000/svg">
